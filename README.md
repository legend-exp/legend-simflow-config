...
- `l200cfg04`: configuration with _only the liquid argon instrumentation
  deployed_, no HPGe array. Data taking period p13, `r001` (Dec 2024).

- `l200cfg05`: same as `cfg04`, but with some new SiPM modules. Since new
...
- `l200cfg06`: 114 kg HPGe array (start: March 2025). No good data was taken
  with this configuration.

- `l200cfg07`: 99 kg HPGe array. Data taking period p14 (start: Apr 2025)

- `l200cfg08`: 138 kg HPGe array. Data taking period from p15 (start: July 2025)
  onwards.
